...
const SectionProfile = () => {
  const logoSectionProfile = {
    backgroundImage: "url('src/assets/assets-Header/moon-3704285_1920.jpg')",
  };
      ...
      <div className="h-full text-white flex items-center relative z-1">
        ...
        >
          ...
          <div className="h-[100vh] flex justify-center items-center z-10">
            <Fade left>
              <div className="w-[80%] h-[70%] bg-white rounded-xl flex flex-col justify-between z-10 mt-10 mdd:mt-20">
                ...
                <div className="h-auto bg-[#04091b] rounded-sm mt-4">
                  <h3>Prenotazione:</h3>
                </div>
                <div className="w-full h-[50%] ring-1 ring-black p-4 my-4 bg-gray-300 md:h-[60%]"></div>
                <div class="  bg-[#04091b] flex rounded-b-md">
                  <div class="py-3 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8 h-auto">
                    ...
                    <p class="mt-8 text-base leading-6 text-center text-gray-300">
                      © 2023 Team InSpace, Inc. All rights reserved.
                    </p>
                  </div>
                </div>
              </div>
