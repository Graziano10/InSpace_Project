      ...
      >
        ...
        >
          ...
          <div className="w-full flex justify-center md:justify-start">
            <button
              type="submit"
              className="text-white submit-btn flex justify-center items-center bg-yellow-600 hover:bg-yellow-600 hover:ring-yellow-600 hover:ring-2 active:ring-0 ring-yellow-600  font-medium rounded-lg text-sm md:text-lg xl:text-xl w-full sm:w-auto px-5 py-2.5 text-center md:w-1/4 "
            >
              Submit
